...
- **📌 GATED GOAL-PACE ADDENDUM (2026-09-06) — does NOT open before Fri Sep 18.** Race pace 6:20/km ≈ **HR 160–168**, and as planned he reaches Oct 11 having never run a step there (only intensity data is Madrid, all-out, HR 180). Fix = **~8 km of goal pace total, placed INSIDE the two longest runs** — no extra sessions, no extra impact days: **Fri Sep 18** 8 k benchmark (**≤5:50/km → sub-3:00 opens · 5:50–6:10 → sub-3:10 confirmed · >6:10 → race conservative**) · **Sun Sep 27** long 18 k = 15 k easy + **final 3 k @ 6:20** · **Sun Oct 4** long 22 k = 17 k easy + **final 5 k @ 6:20**, full kit/fuel rehearsal. **Any pinpoint shin pain VOIDS the whole addendum. Nothing above HR 150 before Sep 18.** Detail → `logs/session_log.md` § "ADDENDUM 2026-09-06".
